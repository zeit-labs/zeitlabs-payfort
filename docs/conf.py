...
"""
zeitlabs_payfort documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'zeitlabs-payfort',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/Zeitlabs/zeitlabs-payfort",
...
#
# html_title = 'zeitlabs_payfort v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Payfort Processor for Zeitlabs Payments Plugin',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'payfort'),
                os.path.join(root_path, 'payfort/migrations')])
