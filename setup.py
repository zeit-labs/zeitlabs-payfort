...
VERSION = get_version('payfort', '__init__.py')
...
setup(
    ...
    author='Zeitlabs Team',
    author_email='oscm@openedx.org',
    url='https://github.com/Zeitlabs/zeitlabs-payfort',
    packages=find_packages(
        include=['payfort', 'payfort.*'],
        exclude=["*tests"],
    ),
